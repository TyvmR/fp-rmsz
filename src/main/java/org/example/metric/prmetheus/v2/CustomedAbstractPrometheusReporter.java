 ...
 */
@PublicEvolving
public abstract class CustomedAbstractPrometheusReporter implements MetricReporter {
	...
	public void open(MetricConfig config) {
		boolean filterLabelValueCharacters = config.getBoolean(
				CustomedPrometheusPushGatewayReporterOptions.FILTER_LABEL_VALUE_CHARACTER.key(),CustomedPrometheusPushGatewayReporterOptions.FILTER_LABEL_VALUE_CHARACTER.defaultValue());
