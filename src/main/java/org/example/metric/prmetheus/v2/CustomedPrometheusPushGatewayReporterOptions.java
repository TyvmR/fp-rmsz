...
/**
 * Config options for the {@link CustomedPrometheusPushGatewayReporter}.
 */
@Documentation.SuffixOption
public class CustomedPrometheusPushGatewayReporterOptions {
	public static final ConfigOption<String> USERNAME = ConfigOptions
			.key("username")
			.noDefaultValue()
			.withDescription("The PushGateway basic auth username.");
	public static final ConfigOption<String> PASSWORD = ConfigOptions
			.key("password")
			.noDefaultValue()
			.withDescription("The PushGateway basic auth password.");
	...
	public static final ConfigOption<String> GROUPING_KEY = ConfigOptions
			...
			.withDescription(Description.builder()
					...
					.build());
	public static final ConfigOption<String> ONLY_REPORT_NAMES = ConfigOptions
			.key("metric.only.report.names")
			.defaultValue("")
			.withDescription(Description.builder()
					.text("Specifies the metric names that will only reported to reporters. others will be blocked.",
