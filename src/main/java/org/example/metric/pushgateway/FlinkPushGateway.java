...
public class FlinkPushGateway {
    public static void main(String[] args) {
        ...
        config.setString("metrics.reporter.promgateway.class","org.apache.flink.metrics.prometheus.CustomedPrometheusPushGatewayReporter");
        config.setString("metrics.reporter.promgateway.host","10.2.3.244");
