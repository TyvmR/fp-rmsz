...
public class AggregationsDemo {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<String, Integer, Long>> input = env.fromElements(
                new Tuple3<>("foo", 8, 1573441871000L),
                new Tuple3<>("foo", 2, 1573441872000L),
                new Tuple3<>("foo", 9, 1573441873000L),
                new Tuple3<>("foo", 4, 1573441874000L),
                new Tuple3<>("foo", 17, 1573441875000L),
                new Tuple3<>("foo", 5, 1573441876000L),
