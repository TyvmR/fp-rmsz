...
public class LogisticRegressionDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //保存模型
        String modelPath = "src/main/resources/LogisticRegressionSentimentModel";
        ...
        pipelineModel.transform(testSource)
                ...
                .print();
        //直接使用保存的模型
        PipelineModel pipelineModel2 =PipelineModel.load(modelPath);
        pipelineModel2.transform(testSource)
                //输出数据
                .select(new String[]{"pre", "label", "review"})
                .firstN(10)
                .print();
