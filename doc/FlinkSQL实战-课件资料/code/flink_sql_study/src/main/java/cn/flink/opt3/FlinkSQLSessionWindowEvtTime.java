...
public class FlinkSQLSessionWindowEvtTime {
    public static void main(String[] args) {
        ...
        Table resultTable = tEnv.sqlQuery("select product_id,max(price) , SESSION_START(date_time,INTERVAL '5' second ) as winstart  from " + table + " group by product_id ,SESSION(date_time,INTERVAL '5' second)");
